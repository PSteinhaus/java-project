...
public class FutternGraphical extends Spiel {
    ...
    // for the client
    public FutternGraphical(int width, int height, String playername1, String playername2) {
        this.session = null;
        this.isServer = false;
        this.spieler = new Spieler[PLAYERNUMBER];
        spieler[0] = new Spieler(playername1, 'x', true);
    ...
    private void startSlick(int width, int height, String playername1, String playername2) {
        ...
        try {
            ...
            //game = new FutternSlick(width,height,playername1,playername2);
